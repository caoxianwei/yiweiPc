<template>
    <div class="recordContent">
        ...
        操作类型: 
        <div class="select ie9-select">
            <el-select v-model="value3" class="wid105 translate3d-zero">
...
<script lang="babel">
    ...
    export default {
        ...
        mounted () {
            for (var i = 0; i < lotteryConstants.typelist2.length; i++) {
                this.options.push(lotteryConstants.typelist2[i])
            }
            var now = new Date()
        ...
        methods :{
            ...
            async searchFlowRecord(param){
                ...
                var flowData = await api.ajax('record/pageCoinChange', this.form)
